							...
							<div class="panel-body" style="padding:30px; padding-bottom:10px; padding-top:10px;">
								<div class="form-group">
									<div class="field field-icon-right">
										<input type="text" value="" autofocus="autofocus" class="input input-big" name="userCode" placeholder="登录账号" data-validate="required:请填写账号" />
										<span class="icon icon-user margin-small"></span>
									</div>
								</div>
								<div class="form-group">
									<div class="field field-icon-right">
										<input type="password" value="" class="input input-big" name="userPwd" placeholder="登录密码" data-validate="required:请填写密码" />
